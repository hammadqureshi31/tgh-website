...
export default function BlogSection() {
  ...
  return (
    <section id="blog" className="py-24 md:py-32 overflow-hidden" style={{ backgroundColor: '#f8f5f0' }}>
          ...
          {posts.map((post, i) => (
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-4">
                <span className="font-mono text-luxury-graphite/40 text-xs" style={{ letterSpacing: '0.1em' }}>
                  {post.date}
                </span>
