...
export default async function BlogPostPage({ params }: Props) {
  ...
  return (
    <div className="min-h-screen pb-12" style={{ backgroundColor: "#F8F5F0" }}>
      <ReadingProgressBar readingTime={post.reading_time} />

      {/* ── SECTION 3: Hero Image (Editorial Style) ─────── */}
      <div className="mb-8">
        <div className="relative w-full overflow-hidden aspect-[4/3] md:aspect-[5/2] bg-luxury-graphite">
          {post.featured_image ? (
            <>
              <Image
              ...
              />
              {/* Cinematic overlays */}
              <div className="absolute inset-0 bg-gradient-to-r from-luxury-midnight/90 via-luxury-midnight/20 to-luxury-midnight/90 z-20" />
              <div className="absolute inset-0 bg-gradient-to-t from-luxury-midnight/80 via-luxury-midnight/10 to-luxury-midnight/80 z-20" />
              {/* Top amber edge */}
              <div className="absolute top-0 left-0 right-0 h-px bg-luxury-amber/60 z-30" />
              {/* Content */}
              <h1
                className="absolute w-full text-center top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 font-playfair text-3xl md:text-4xl lg:text-5xl text-luxury-amber z-30 mb-6"
            ...
            <div className="w-full h-full flex items-center justify-center bg-luxury-midnight/5 border border-luxury-midnight/10">
              <span className="font-mono text-luxury-midnight/20 text-sm uppercase tracking-widest">
                Image unavailable
              </span>
            </div>
          )}
          ...
          <article className=" lg:col-span-10 lg:col-start-4 xl:col-start-4 xl:col-span-10 max-w-[1000px] mx-auto w-full">
            ...
            <div
              ...
              className={cn(
                ...
                // H2
                "[&>h2]:font-playfair [&>h2]:text-2xl [&>h2]:md:text-3xl [&>h2]:text-luxury-midnight [&>h2]:mt-12 [&>h2]:mb-4 [&>h2]:pb-4 [&>h2]:border-b [&>h2]:border-luxury-midnight/8",
                // H3
